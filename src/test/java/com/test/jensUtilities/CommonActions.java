package com.test.jensUtilities;
...
private WebDriverWait wait;
	...
	public String getScreenshot() 
	{
		  ...
		  Date d = new Date(); DateFormat ft = new SimpleDateFormat("ddMMyyyyhhmmss");
		...
		try {
		  ...
		  SrcFile=ts.getScreenshotAs(OutputType.FILE); //Move image file to new	  destination 
		  File DestFile=new File(path); //Copy file at destination try {
